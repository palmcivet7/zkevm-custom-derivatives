...
contract CustomDerivative {
    ...
    IProxy public immutable priceFeed;
     ...
     * @param _priceFeed The PriceFeed address of the underlying asset
     ...
     * @dev This function uses API3 for retrieving Price Feed data because Chainlink isn't available on zkEVM.
     */
    function settleContract() public notSettledOrCancelled {
        ...
        (int224 price,) = IProxy(priceFeed).read();
        uint256 finalPrice = uint256(uint224(price));
